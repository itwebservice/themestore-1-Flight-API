...
////////////////////////////////// END /////////////////////////////////////////////
?>
<section class="print_header main_block" style="margin-bottom: 50px !important;">
...
<div class="row">
	...
	<div class="col-md-12">
		<div class="table-responsive">
			<table class="table table-bordered no-marg" id="tbl_list_ledger_sub" style="padding: 0px !important;">
				<thead>
				...
				<tbody>
					...
					while ($row_ledger = mysqli_fetch_assoc($sq_ledger_info)) {
						...
						$balance_column = floatval($balance_column) + floatval($debit_amount) - floatval($credit_amount);
						if ($chk_trans == 1) {
							$temp_arr = array(
					...
					?>
							<tr>
								...
								<td style="max-width:250px !important; overflow-wrap: break-word;">
									<?= $row_ledger['payment_particular'] ?></td>
								<td><?= $debit_amount ?></td>
								<td><?= $credit_amount ?></td>
				...
				<tfoot>
					...
					<?php } else { ?>
						<tr class="table-heading-row">
							...
							<td></td>
							<td class="text-right">Total : </td>
							<td class="text-right"><?= number_format($total_debit1, 2) ?></td>
							<td class="text-right"><?= number_format($total_credit1, 2) ?></td>
							<td></td>
						</tr>
						<tr class="table-heading-row">
							<td></td>
