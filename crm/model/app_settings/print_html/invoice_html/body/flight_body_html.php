...
$net_amount1 =  $basic_cost1 + $sq_fields['service_charge'] + $sq_fields['markup'] + $other_tax + $yq_tax + $markupservice_tax_amount + $service_tax_amount - $sq_fields['basic_cost_discount'] - $sq_fields['tds'] + $sq_fields['roundoff']; 
