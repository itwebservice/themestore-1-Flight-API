                ...
                <table class="table no-marg tableTrnasp">
                  ...
                  <tbody>
                    ...
                    while ($sq_costing = mysqli_fetch_assoc($sq_costing1)) {
                      ...
                      $quotation_cost = ceil($quotation_cost);
                      $tcs_show=currency_conversion($currency, $sq_quotation['currency_code'], $tcsvalue) ;
                      ////////////////Currency conversion ////////////
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="font-size: 14px !important; padding: 8px  20px !important;">Tcs:(<?=$tcsper?>%)<br><?=$tcs_show?></td>
