...
while($row_pass = mysqli_fetch_assoc($sq_pass)){
    ...
    $net_total = floatval($costing_data[0]->net_total);
        ...
        <div class="col-md-12">
          <div class="adolence_info">
            <ul class="main_block">
              ...
              <li class="col-md-4"><span>Other Expense : </span><?php echo ($row_exp_count > 0) ? number_format(floatval($row_exp['exp_paid']),2) : 0; ?></li>
            </ul>
          </div>
        </div>
      </div>
