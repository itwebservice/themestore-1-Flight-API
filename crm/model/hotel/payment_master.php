...
public function payment_save(){
  ...
  $booking_id = explode('-',$_POST['booking_id'])[0];
...
public function payment_delete(){
  ...
  $sq_hotel_payment = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_payment where payment_id='$payment_id'"));
  $booking_id = $sq_hotel_payment['booking_id'];
  $credit_charges = $sq_hotel_payment['credit_charges'];
  $credit_card_details = $sq_hotel_payment['credit_card_details'];
  $payment_mode = $sq_hotel_payment['payment_mode'];
  $payment_amount = $sq_hotel_payment['payment_amount'];
  $bank_id = $sq_hotel_payment['bank_id'];
  $bank_name = $sq_hotel_payment['bank_name'];
  $transaction_id1 = $sq_hotel_payment['transaction_id'];
  $payment_date1 = $sq_hotel_payment['payment_date']; 
  $canc_status = $sq_hotel_payment['status'];
  $sq_hotel_booking = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_master where booking_id='$booking_id'"));
  $customer_id = $sq_hotel_booking['customer_id'];
  $booking_date = $sq_hotel_booking['created_at'];
  ...
  $trans_id = get_hotel_booking_payment_id($payment_id,$yr2).' : '.$cust_name;
  $transaction_master->updated_entries('Hotel Receipt',$booking_id,$trans_id,$payment_amount,0);
  ...
  $delete_master->delete_master_entries('Receipt('.$payment_mode.')','Hotel Receipt',$payment_id,get_hotel_booking_payment_id($payment_id,$yr2),$cust_name,$payment_amount);
  //////////Payment Amount///////////
  if($payment_mode != 'Credit Note'){
    if($payment_mode == 'Credit Card'){
      ...
      $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr2), $deleted_date, $credit_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
      ...
      $payment_amount = 0;
      $payment_date = $deleted_date;
      $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr2), $deleted_date, 0, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
      $ledger_particular = get_ledger_particular('By','Cash/Bank');
      $old_gl_id = $gl_id = 231;
      $payment_side = "Debit";
      $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
      ...
      $payment_amount = 0;
      $payment_date = $deleted_date;
      $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $deleted_date, $payment_amount1, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
      $ledger_particular = get_ledger_particular('By','Cash/Bank');
      ...
      $payment_amount = 0;
      $payment_date = $deleted_date;
      $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $deleted_date, $payment_amount1, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
      $ledger_particular = get_ledger_particular('By','Cash/Bank');
      $old_gl_id = $gl_id = $cust_gl;
      $payment_side = "Credit";
      $clearance_status = "";
  ...
  $bank_id = $bank_id;
  $particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date, $payment_amount, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id,$canc_status);
  ...
  $sq_delete = mysqlQuery("update hotel_booking_payment set payment_amount = '0', delete_status='1',credit_charges='0' where payment_id='$payment_id'");
  if($sq_delete){
...
public function finance_save($payment_id, $branch_admin_id)
{
  ...
  $sq_hotel_booking_info = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_master where booking_id='$booking_id'"));
  ...
  if($payment_mode == 'Cash') {  $pay_gl = 20; $type='CASH RECEIPT'; }
    ...
    if($payment_mode != 'Credit Note'){
      if($payment_mode == 'Credit Card'){
        ...
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $credit_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $cust_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = 231;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $credit_company_amount, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $company_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $payment_amount1, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $pay_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
      ...
      $payment_amount = $payment_amount1;
      $payment_date = $payment_date1;
      $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $payment_amount1, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
      $ledger_particular = get_ledger_particular('By','Cash/Bank');
      $gl_id = $cust_gl;
      $payment_side = "Credit";
      $clearance_status = "";
...
public function bank_cash_book_save($payment_id, $branch_admin_id)
{
  ...
  $payment_date1 = get_date_db($payment_date);
	$year2 = explode("-", $payment_date1);
  $yr1 =$year2[0];
  $sq_hotel_booking_info = mysqli_fetch_assoc(mysqlQuery("select customer_id from hotel_booking_master where booking_id='$booking_id'"));  
  ...
  $transaction_id = $transaction_id;
  $bank_id = $bank_id; 
  $particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date, $payment_amount, $sq_hotel_booking_info['customer_id'], $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id,$canc_status);
  $clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
  $payment_side = "Debit";
  $payment_type = ($payment_mode=="Cash") ? "Cash" : "Bank";
...
public function payment_update()
{
  ...
  if(!$sq_payment){
    ...
    if(floatval($payment_old_value) != floatval($payment_amount)){
      ...
      $year = $yr[0];
      $sq_package = mysqli_fetch_assoc(mysqlQuery("select customer_id from hotel_booking_master where booking_id='$booking_id'"));
      ...
      $trans_id = get_hotel_booking_payment_id($payment_id,$year).' : '.$cust_name;
      $transaction_master->updated_entries('Hotel Receipt',$booking_id,$trans_id,$payment_old_value,$payment_amount);
    }
...
public function finance_update($sq_payment_info, $clearance_status1)
{
  ...
  $sq_hotel_info = mysqli_fetch_assoc(mysqlQuery("select customer_id from hotel_booking_master where booking_id='$booking_id'"));
  ...
  if($payment_amount1 != $payment_old_value){
    if($payment_mode != 'Credit Note'){
		...
		if($payment_mode == 'Credit Card'){
			...
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $credit_charges_old, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $cust_gl;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
      ...
      $finance_charges = number_format($finance_charges,2);
			...
			$payment_amount = $finance_charges;
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 231;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
			...
			$payment_amount = $credit_company_amount;
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $credit_company_amount, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $company_gl;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
			...
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date, $payment_old_value, $sq_hotel_info['customer_id'], $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $pay_gl;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
		...
		$payment_amount = $payment_old_value;
		$payment_date = $payment_date1;
		$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $payment_old_value, $sq_hotel_info['customer_id'], $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1,$canc_status);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = $cust_gl;
		$payment_side = "Debit";
		$clearance_status = "";
...
public function payment_email_notification_send($booking_id, $payment_amount, $payment_mode, $payment_date)
{
  ...
  $sq_customer_info = mysqli_fetch_assoc(mysqlQuery("select email_id,first_name,type,company_name,last_name from customer_master where customer_id='$sq_hotel_info[customer_id]'"));
  ...
  $due_date = ($sq_hotel_info['due_date'] == '1970-01-01') ? '' : $sq_hotel_info['due_date'];  
  $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sum, sum(credit_charges) as sumc from hotel_booking_payment where booking_id='$booking_id' and clearance_status!='Cancelled'"));
  $credit_card_amount = $sq_total_amount['sumc'];
  $total_amount = $sq_hotel_info['total_fee'] + $credit_card_amount;
  $total_pay_amt = $sq_total_amount['sum'] + $credit_card_amount;

  $pass_count= mysqli_num_rows(mysqlQuery("select * from hotel_booking_entries where booking_id='$booking_id'"));
  $cancle_count= mysqli_num_rows(mysqlQuery("select * from hotel_booking_entries where booking_id='$booking_id' and status='Cancel'"));
  ...
  $payment_id = get_hotel_booking_payment_id($booking_id,$year);

  $subject = 'Payment Acknowledgement (Booking ID : '.get_hotel_booking_id($booking_id,$year).' )';
  global $model;
  $model->generic_payment_mail('50',$payment_amount, $payment_mode, $total_amount, $total_pay_amt, $payment_date, $due_date,$email_id, $subject,$customer_name,$sq_hotel_info['currency_code'],$outstanding);
}
...
public function payment_update_email_notification_send($payment_id)
{
  ...
  global $encrypt_decrypt,$secret_key;
  $sq_payment_info = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_payment where payment_id='$payment_id' and clearance_status!='Cancelled'"));
  ...
  global $model;
    $model->generic_payment_mail('60',$payment_amount, $payment_mode, $total_amount, $total_pay_amt, $payment_date, $due_date,$email_id,$subject,$customer_name,$sq_hotel_info['currency_code']);
}
...
public function payment_sms_notification_send($booking_id, $payment_amount, $payment_mode)
{
  ...
  $message ="Dear ".$sq_customer_info['first_name']." ".$sq_customer_info['last_name'].", Acknowledge your payment of ".$payment_amount." ".$currency_code.",".$payment_mode." which we received for Hotel booking installment.";
    global $model;
...
public function whatsapp_send(){
  ...
  global $encrypt_decrypt,$secret_key,$currency,$app_name,$session_emp_id,$app_contact_no;
  $booking_id = $_POST['booking_id'];

  $sq_hotel_info = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_master where booking_id=".$booking_id));

  $sq_pay = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sum, sum(credit_charges) as sumc from hotel_booking_payment where clearance_status!='Cancelled' and booking_id=".$booking_id));
  ...
  $sq_customer = mysqli_fetch_assoc(mysqlQuery("select * from customer_master where customer_id=".$sq_hotel_info['customer_id']));
  ...
  $total_amount1 = currency_conversion($currency,$sq_hotel_info['currency_code'],$total_amount);
