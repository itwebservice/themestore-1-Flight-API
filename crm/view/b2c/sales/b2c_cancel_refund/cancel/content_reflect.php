                ...
                callback: function(data1){
                    if(data1=="yes"){
                        ...
                        $.ajax({
                          ...
                          data:{ booking_id : booking_id, cancel_amount : cancel_amount, total_refund_amount : total_refund_amount, final_total : total_sale, main_tax_total : total_tax,tax_value:tax_value,tour_service_tax_subtotal:tour_service_tax_subtotal,cancel_amount_exc:cancel_amount_exc,ledger_posting:ledger_posting },
