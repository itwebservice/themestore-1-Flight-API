...
<form id="section_meta_tags">
    ...
    <div class="row">
        <div class="col-md-12 text-right">
            ...
            <a target="_blank" href="https://www.youtube.com/watch?v=ClXTdjsXKFU" class="btn btn-sm btn-success text-right"><i class="fa fa-eye"></i>Reference video</a>
        </div>
    </div>
                ...
                <table id="tbl_meta_tags" name="tbl_meta_tags" class="table border_0 table-hover" style="width:1000px;">
                    ...
                    if ($sq_count == 0) { ?>
                        <tr>
                            ...
                            <td><textarea id="title-1" name="title" title="*Title" placeholder="*Title" onchange="validate_char_size('title-1',120);" rows="1" style="width:120px; height:40px;"></textarea></td>
                            <td><textarea id="description-1" name="description" title="*Description" placeholder="*Description" onchange="validate_char_size('description-1',200);" rows="1" style="width:120px; height:40px;"></textarea></td>
                            <td><textarea id="keywords-1" name="keywords" title="*Keywords" placeholder="*Keywords" onchange="validate_char_size('keywords-1',500);" rows="1" style="width:120px; height:40px;"></textarea></td>
                            ...
                            <tr>
                                ...
                                <td><select name="page-1" id="page-1<?= $i ?>_u" title="Select Page" class="form-control app_select2" style="width:150px" class="form-control">
                                        ...
                                        if ($row_query['page'] == 'index')
                                            ...
                                            $page = 'visa';
                                        else if ($row_query['page'] == 'Car Rental')
                                            $page = 'Car Rental';
                                        else if ($row_query['page'] == 'Cruise')
                                            $page = 'Cruise';
                                ...
                                <td><input type="hidden" id="entry_id-1<?= $i ?>_u" value='<?= $row_query['entry_id'] ?>' />
                                </td>
                            </tr>
                            <script>
                                $('#page-1<?= $i ?>_u').select2();
            ...
            submitHandler: function(form) {
                ...
                for (var i = 0; i < rowCount; i++) {
                    ...
                    if (row.cells[0].childNodes[0].checked) {
                        ...
                        if (page == "") {
                            error_msg_alert("Select page at row " + (i + 1));
                            return false;
                        }
                        if (title == "") {
                        ...
                        if (keyword == "") {
                            error_msg_alert("Enter keywords at row " + (i + 1));
                            return false;
                        }
