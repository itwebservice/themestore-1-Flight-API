...
?>
		...
		<tr>
			<td class='col-md-1 pad_8'><input type="text" id="day<?php echo $i+1; ?>" name="day" class="form-control mg_bt_10" placeholder="Day <?php echo $i+1; ?>" title="Day" value="" disabled> </td>
