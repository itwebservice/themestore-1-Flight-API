  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="col-md-4 col-xs-12 mg_bt_10">
...
function generate_identifier_block(identifier_count,i){
  ...
  if(identifier_count === '' || parseInt(identifier_count) === 0){
    error_msg_alert("Enter valid identifier count!"); 
    return false;
  }
  ...
  $('#frm_save').validate({
    ...
    submitHandler:function(form){
        ...
        if(identifier_count=='' || identifier_count > 9 || identifier_count === 0){
          error_msg_alert('Enter valid identifier count(should not be 0 or greater than 9)');
          return false;
        }
