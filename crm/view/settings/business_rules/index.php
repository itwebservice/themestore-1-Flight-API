...
function business_rules_reflect(){
	...
	if(id=="rd_taxes"){
		$.post('business_rules/taxes/index.php', {}, function(data){
			$('#div_rules').html(data);
		});
	}
	if(id=="rd_tax_rules"){
		$.post('business_rules/taxes_rules/index.php', {}, function(data){
			$('#div_rules').html(data);
		});
	}
	if(id=="rd_other_rules"){
		$.post('business_rules/other/index.php', {}, function(data){
			$('#div_rules').html(data);
		});
	}
	if(id=="rd_tcs"){
		$.post('business_rules/tcs/index.php', {}, function(data){
			$('#div_rules').html(data);
		});
	}
}
...
function values_load(id){
	...
	if(condition === "2"){
		...
		$.post('business_rules/get_condition_values.php', {condition : condition}, function(data){
