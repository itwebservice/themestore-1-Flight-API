                ...
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    ...
                    <div class="row mg_bt_10">
                        ...
                        <div class="col-xs-12 no-pad mg_bt_20">
                            <div class="col-md-3 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="package_name" name="package_name" onchange="package_name_validation(this.id);package_name_check(this.id);" class="form-control" placeholder="*Package Name" title="Package Name" />
