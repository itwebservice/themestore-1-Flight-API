                            ...
                            <div class="bg_white main_block panel-default-inner">
                                ...
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20">
                                    ...
                                    <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                                        ...
                                        <input type="text" id="package_name1" name="package_name" class="form-control" placeholder="Package Name" title="Package Name" value="<?php echo $sq_pckg['package_name']; ?>" onchange="package_name_validation(this.id);" <?= $readable ?> />
                                ...
                                <table style="width: 100%" id="dynamic_table_list_update" name="dynamic_table_list_update" class="table table-bordered table-hover table-striped no-marg pd_bt_51 mg_bt_0">
                                    ...
                                    while ($sq_pckg1 = mysqli_fetch_assoc($sq_pckg_a)) { ?>
                                        <tr>
                                            ...
                                            <td class='hidden col-md-1 pad_8'><input maxlength="15" value="<?php echo $count; ?>" type="text" name="username" placeholder="Sr. No." class="form-control mg_bt_10" disabled="" autocomplete="off" data-original-title="" title="" style='width:10px'>
                                            </td>
                                            ...
                                            <td class='col-md-1 pad_8'><select id="meal_plan<?php echo $count; ?>" title="Meal Plan" name="meal_plan" class="form-control mg_bt_10" style='width:125px'>
                                            ...
                                            <td class='col-md-1 pad_8'><button type="button" id="itinerary<?php echo $count; ?>" class="btn btn-info btn-iti btn-sm" title="Add Itinerary" style="border: none !important;" onClick="add_itinerary('dest_name_u','special_attaraction<?php echo $count; ?>-u','day_program<?php echo $count; ?>-u','overnight_stay<?php echo $count; ?>-u','Day-<?= $count ?>')"><i class="fa fa-plus"></i></button>
                                            </td>
