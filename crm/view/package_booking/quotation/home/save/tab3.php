                                                    ...
                                                    <table id="tbl_package_tour_quotation_dynamic_train"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input maxlength="15" value="1" type="text"
                                                                    name="username" placeholder="Sr. No."
                                                                    class="form-control" disabled /></td>
                                                            <td class="col-md-2"><select id="train_from_location1"
                                                            ...
                                                            <td class="col-md-2"><select id="train_to_location1"
                                                            ...
                                                            <td class="col-md-2"><select name="train_class"
                                                                    id="train_class1" title="Class">
                                                            ...
                                                            <td class="col-md-3"><input type="text"
                                                                    ...
                                                                    placeholder="Departure Date and time"
                                                                    title="Departure Date and time"
                                                                    class="app_datetimepicker" style="width:180px;"
                                                            ...
                                                            <td class="col-md-3"><input type="text"
                                                                    ...
                                                                    title="Arrival Date and time"
                                                                    class="app_datetimepicker"
                                                                    value="<?= date('d-m-Y H:i') ?>" style="width:180px;"
