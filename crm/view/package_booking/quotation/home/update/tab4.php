                                                        ...
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="tbl_package_tour_quotation_dynamic_costing"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="header_btn"><small>&nbsp;</small><input type="text"
                                                                         ...
                                                                         <td class="header_btn">
                                                                            ...
                                                                            <select title="TCS" id="tcs_tax" name="tcs_tax-<?= $count ?>" class="form-control" style="width: 150px!important;">
                                                                 ...
                                                                 <td class="header_btn">
                                                                            <small id="tcs_tax_show-" style="color:#000000">&nbsp;</small>
                                                                             <input type="number" name="tcs-<?= $count ?>" id="tcs1-" readonly class="text-right"
...
//     var service_charge=$('#service_charge-1').val();
// 	var basic_amount= $('#basic_amount-1').val();
//     if(tcs_tax!=='')
//     {
//        var  subtotal=$("#basic_amount-1").val();
//        subtotal=parseFloat(subtotal)+parseFloat($("#service_charge-1").val());
//        var txt_actual_tour_cost1=$("#total_tour_cost-1").val();
//        var  service_tax_amount=0;
//        var  tax_subtotal=$("#service_tax_subtotal-1").val();
//        var service_tax_subtotal1 = tax_subtotal.split(',');
// 	   for (var i = 0; i < service_tax_subtotal1.length; i++) {
// 		    var service_tax = service_tax_subtotal1[i].split(':');
// 		    service_tax_amount = parseFloat(service_tax_amount) + parseFloat(service_tax[2]);
// 	   }
//        var tcsamount=parseFloat(parseFloat(service_tax_amount)+parseFloat(service_charge)+parseFloat(basic_amount))*parseFloat(tcs_tax)/100;
