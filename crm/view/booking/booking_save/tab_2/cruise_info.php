...
<div class="row mg_bt_30"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_dynamic_cruise_package_booking" name="tbl_dynamic_cruise_package_booking" class="table table-bordered table-hover mg_bt_30 no-marg-sm">
        <tr>
            ...
            <td><input type="text" id="cruise_departure_date" name="cruise_departure_date" placeholder="Departure Date & Time" title="Departure Date & Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i') ?>" onchange="get_to_datetime(this.id,'cruise_arrival_date');" style="width:156px"></td>
            <td><input type="text" id="cruise_arrival_date" name="cruise_arrival_date" placeholder="Arrival Date & Time" title="Arrival Date & Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i') ?>" style="width:156px" onchange="validate_validDatetime('cruise_departure_date',this.id)"></td>
