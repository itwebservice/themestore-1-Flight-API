			...
			if (data == 'yes') {
				...
				$.post(
					base_url + 'controller/group_tour/booking/booking_details_complete_update.php',
					{
						...
						reflections: reflections, total_discount: total_discount, roundoff: roundoff, bsmValues: bsmValues,currency_code:currency_code,tcs_tax:tcs_tax,tcs:tcs,single_person:single_person,single_person_cost:single_person_cost,old_total:old_total
					},
					function (data) {
