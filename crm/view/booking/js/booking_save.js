										...
										if (result == 'yes') {
											...
											$.post(
												...
												'controller/group_tour/booking/booking_details_complete_save.php',
												{
													...
													basic_amount: basic_amount, roundoff: roundoff, bsmValues: bsmValues, total_discount: total_discount, credit_charges: credit_charges, credit_card_details: credit_card_details,currency_code:gcurrency_code,tcs_tax:tcs_tax,tcs:tcs,single_person:single_person,single_person_cost:single_person_cost
												},
												function (data) {
													var msg1 = data.split('-');
