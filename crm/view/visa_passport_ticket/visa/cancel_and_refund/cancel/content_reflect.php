...
<div class="row mg_tp_20 mg_bt_20">
	...
	<div class="col-md-10  col-md-offset-1 col-sm-12 col-xs-12">
		<div class="widget_parent-bg-img bg-img-red">
			...
			$content_arr = array(floatval($visa_amount), floatval($service_charge), floatval($service_tax_amount), floatval($sq_visa_info['markup']), floatval($markupservice_tax_amount), floatval($sq_visa_info['roundoff']), floatval($sq_visa_info['visa_total_cost']), floatval($sq_payment_info['sum']));
			$percent = ($sq_visa_info['visa_total_cost']!='0')?(floatval($sq_payment_info['sum']) / floatval($sq_visa_info['visa_total_cost'])) * 100:0;
