...
$sq_vendor = mysqli_fetch_assoc(mysqlQuery("select * from train_ticket_vendor where vendor_id='$vendor_id'"));
$vendor_name = addslashes($sq_vendor['vendor_name']);
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_vendor[mobile_no]' and vendor_type='Train Ticket Vendor'"));
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Train-Ticket Supplier Details</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
              <input type="text" id="supp_pan1" name="supp_pan" onchange="validate_alphanumeric(this.id);" value="<?= $sq_vendor['pan_no']?>" placeholder="Personal Identification No(PIN)" title="Personal Identification No(PIN)" style="text-transform: uppercase;">
          </div>  
          <div class="col-md-3 col-sm-6 mg_bt_10">
