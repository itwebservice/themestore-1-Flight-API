		  		...
		  		<div class="profile_box">
                    ...
                    <table  class="table table-bordered no-marg">
                     ...
                     <tbody>
                       <?php 
                       $count = 0;
                       $sq_query = mysqlQuery("SELECT * FROM vendor_estimate WHERE status!='Cancel' and estimate_type LIKE  'Train' AND estimate_type_id = '$train_ticket_id' and delete_status='0'");
