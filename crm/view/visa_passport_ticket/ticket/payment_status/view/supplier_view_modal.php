...
<div class="modal fade profile_box_modal" id="flight_display_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
              ...
              <div class="table-responsive">
                  <table  class="table table-bordered no-marg">
                    ...
                    <tbody>
                      <?php 
                      $count = 0;
                      $sq_query = mysqlQuery("SELECT * FROM vendor_estimate WHERE status!='Cancel' and estimate_type LIKE  'Flight' AND estimate_type_id = '$ticket_id' and delete_status='0'");
...
<script>
$('#flight_display_modal').modal('show');
</script>