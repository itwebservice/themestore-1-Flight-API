...
<script>
$('#rfrom_date_filter,#rto_date_filter').datetimepicker({format: 'd-m-Y',timepicker:false});
function get_payment_reminders(){
	...
	$.post('reminders/payment.php', { from_date :from_date,to_date:to_date }, function(data){
