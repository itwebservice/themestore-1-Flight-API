...
$sq_vendor = mysqli_fetch_assoc(mysqlQuery("select * from insuarance_vendor where vendor_id='$vendor_id'"));
$vendor_name = addslashes($sq_vendor['vendor_name']);
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_vendor[mobile_no]' and vendor_type='Insuarance Vendor'"));
...
<div class="modal fade" id="update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Update Insurance Supplier Details</h4>
		</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-6 mg_bt_10">
				<input type="text" id="concern_person_name" name="concern_person_name" placeholder="Contact Person Name" title="Contact Person Name" value="<?= $sq_vendor['concern_person_name'] ?>">
			</div>
			<div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">			
			...
			<div class="col-md-3 col-sm-6 mg_bt_10">
				<input type="number" class="form-control" id="opening_balance" name="opening_balance" placeholder="*Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" >
			</div>
            <div class="col-md-3 col-sm-6 mg_bt_10">
