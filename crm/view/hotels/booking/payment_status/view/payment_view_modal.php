...
$sq_count1 = mysqli_num_rows(mysqlQuery("SELECT booking_id FROM hotel_booking_payment WHERE booking_id = '$booking_id' and payment_amount!=0"));
?>
          ...
          <?php if($sq_count1!=0){ ?>
                  ...
                  <table  class="table table-bordered no-marg">
                    ...
                    <tbody>
                      <?php 
                      $count = 0;
                      $sq_query = mysqlQuery("SELECT * FROM hotel_booking_payment WHERE booking_id = '$booking_id' and payment_amount!=0 ");
