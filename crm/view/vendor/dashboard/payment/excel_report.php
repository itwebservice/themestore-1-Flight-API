...
$count = 0;
	...
	$objPHPExcel->getActiveSheet()->getStyle('B'.$row_count.':K'.$row_count)->applyFromArray($borderArray);    
        ...
        ->setCellValue('H'.$row_count, "Total Amount : ".number_format($total_payment, 2))
        ...
        ->setCellValue('K'.$row_count, "Total Paid : ".number_format(($total_payment - $sq_pending_amount - $sq_cancel_amount), 2));
