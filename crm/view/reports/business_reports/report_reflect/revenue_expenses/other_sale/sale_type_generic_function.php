	...
	if($sale_type == 'Flight Ticket'){
		...
		while ($row_exc = mysqli_fetch_assoc($sq_exc)) {
			...
			if($row_exc['cancel_type'] == '2'||$row_exc['cancel_type'] == '3'){
				...
				$ticket_total_costf = 0; $service_tax_markupf = 0; $service_tax_subtotalf = 0;
				...
				$sale_amount = ($row_exc['ticket_total_cost'] - floatval($ticket_total_costf) - floatval($service_tax_subtotalf) - floatval($service_tax_markupf));
			}else{
